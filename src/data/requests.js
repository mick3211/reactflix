...
const requests = [
    ...
    `${BASE_URL}discover/movie?api_key=${KEY}&language=pt-BR&sort_by=popularity.desc&include_adult=true&include_video=false&page=1&with_genres=35&with_watch_monetization_types=flatrate`,
];
